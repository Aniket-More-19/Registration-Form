...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('styles/signup.css') ?>">
...
<body>
    ...
    <section class="signup-page-container d-flex flex-row justify-content-center align-items-center">
